...
const prelaunchfundETH = new ReserveTransfer({
      ...
      feeCurrencyID: "iJhCezBExJHvtyH3fGhNnt2NhU4Ztkf2yq", // fee currency vrsctest
      feeAmount: new BN(2000000, 10),
      transferDestination: new TransferDestination({
        type: new BN(2, 10),
        destinationBytes: Buffer.from("9bB2772Aa50ec96ce1305D926B9CC29b7c402bAD", 'hex'),
        fees: new BN(0, 10)
      }),
      destCurrencyID: "iJhCezBExJHvtyH3fGhNnt2NhU4Ztkf2yq"
    })
...
const bounceback = new ReserveTransfer({  // The bridge currency has to be launched for this TX ETH -> VRSCTEST back to ETH address
    ...
    feeCurrencyID: "iCtawpxUiCc2sEupt7Z4u8SDAncGZpgSKm",  // fee currency veth
    feeAmount: new BN(300000, 10),   // 0.003 ETH FEE SATS (8 decimal places)
    transferDestination: new TransferDestination({
      type: new BN(DEST_ETH + FLAG_DEST_AUX + FLAG_DEST_GATEWAY, 10),
      destinationBytes: Buffer.from("9bB2772Aa50ec96ce1305D926B9CC29b7c402bAD", 'hex'),
      gatewayID: "iCtawpxUiCc2sEupt7Z4u8SDAncGZpgSKm",
      fees: new BN(300000, 10),
      auxDests:[new TransferDestination({
        type: new BN(DEST_PKH, 10),
        destinationBytes: Buffer.from("9bB2772Aa50ec96ce1305D926B9CC29b7c402bAD", 'hex')})]
    }),
    destCurrencyID: "iSojYsotVzXz4wh2eJriASGo6UidJDDhL2",
    secondReserveID: "iJhCezBExJHvtyH3fGhNnt2NhU4Ztkf2yq"
  })
...
const verusReserveTransfer = new ReserveTransfer({  // The bridge currency has to be launched for this TX ETH -> VRSCTEST back to ETH address
  ...
  destCurrencyID: "iCtawpxUiCc2sEupt7Z4u8SDAncGZpgSKm"
})
...
const erc721transferETH = new ReserveTransfer({  
  ...
  transferDestination: new TransferDestination({
    ...
    destinationBytes: Buffer.from("", 'hex'),
  }),
  destCurrencyID: "iCtawpxUiCc2sEupt7Z4u8SDAncGZpgSKm"
})
...
const erc721transferVerus = new ReserveTransfer({ 
  ...
  transferDestination: new TransferDestination({
    type: new BN(DEST_REGISTERCURRENCY, 10),
    destinationBytes: Buffer.from("", 'hex'),
  }),
  destCurrencyID: "iCtawpxUiCc2sEupt7Z4u8SDAncGZpgSKm"
})
...
const erc20verustoken = new ReserveTransfer({ 
  ...
  transferDestination: new TransferDestination({
    type: new BN(DEST_REGISTERCURRENCY, 10),
    destinationBytes: Buffer.from("", 'hex'),
  }),
  destCurrencyID: "iCtawpxUiCc2sEupt7Z4u8SDAncGZpgSKm"
})
...
const erc20ETHtoken = new ReserveTransfer({  
  ...
  transferDestination: new TransferDestination({
    type: new BN(DEST_REGISTERCURRENCY, 10),
    destinationBytes: Buffer.from("", 'hex'),
  }),
  destCurrencyID: "iCtawpxUiCc2sEupt7Z4u8SDAncGZpgSKm"
})
...
const erc1155VerusNFT = new ReserveTransfer({  
  ...
  transferDestination: new TransferDestination({
    type: new BN(DEST_REGISTERCURRENCY, 10),
    destinationBytes: Buffer.from("", 'hex'),
  }),
  destCurrencyID: "iCtawpxUiCc2sEupt7Z4u8SDAncGZpgSKm"
})
...
const erc1155Token = new ReserveTransfer({  
  ...
  transferDestination: new TransferDestination({
    type: new BN(DEST_REGISTERCURRENCY, 10),
    destinationBytes: Buffer.from("", 'hex'),
  }),
  destCurrencyID: "iCtawpxUiCc2sEupt7Z4u8SDAncGZpgSKm"
})
...
const testErcVerus = new ReserveTransfer({  
  ...
  feeCurrencyID: "iCtawpxUiCc2sEupt7Z4u8SDAncGZpgSKm",  // fee currency veth
  feeAmount: new BN(540000, 10),   // 0.0054 ETH FEE SATS (8 decimal places)
  transferDestination: new TransferDestination({
    type: new BN(DEST_REGISTERCURRENCY, 10),
    destinationBytes: Buffer.from("", 'hex'),
  }),
  destCurrencyID: "iCtawpxUiCc2sEupt7Z4u8SDAncGZpgSKm",
  destSystemID: "iCtawpxUiCc2sEupt7Z4u8SDAncGZpgSKm"
})
