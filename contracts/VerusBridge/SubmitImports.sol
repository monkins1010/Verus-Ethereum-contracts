...
contract SubmitImports is VerusStorage {
    ...
    function claimfees() public {
        ...
        if ((claimableFees[VerusConstants.VDXF_SYSTEM_NOTARIZATION_NOTARYFEEPOOL] * VerusConstants.SATS_TO_WEI_STD) > 0.5 ether)
        {
            uint256 txReimburse;

            // truncate reimburse amount
            txReimburse = ((tx.gasprice * VerusConstants.SEND_GAS_PRICE) / VerusConstants.SATS_TO_WEI_STD) * VerusConstants.SATS_TO_WEI_STD;
